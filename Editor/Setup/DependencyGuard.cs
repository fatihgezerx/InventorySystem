...
namespace InventorySystem.Setup
{
    /// <summary>
    /// Keeps Inventory System from ever breaking a project that doesn't have its dependencies yet.
    /// </summary>
    /// <remarks>
    ...
    /// (e.g. <c>HAS_UNITASK</c>). Inventory System's own assemblies list those symbols as Define Constraints,
    /// so while a dependency is missing they are simply left out of compilation - no errors - and this
    /// guard offers to install what's missing. Once it is installed, the symbol is set and Inventory System
    ...
    internal sealed class DependencyGuard : AssetPostprocessor, IActiveBuildTargetChanged
    {
        ...
        private const string MenuPath = "Tools/Inventory System/Check Dependencies";
        private const string DontAskKey = "InventorySystem.Setup.DontAskForDependencies";
        private const string PromptedKey = "InventorySystem.Setup.PromptedForDependencies";
        ...
        internal static readonly Dependency[] Dependencies =
        {
            ...
            new Dependency("UniMVC", "UniMVC.Runtime", "HAS_UNIMVC", "https://github.com/fatihgezerx/UniMVC.git", "com.fatihgezer.unimvc", "for the inventory UI"),
            new Dependency("Input System", "Unity.InputSystem", "HAS_INPUT_SYSTEM", "com.unity.inputsystem", "com.unity.inputsystem", "for the inventory UI (open / close key, rotate)"),
        };
    ...
    /// <summary>One package Inventory System uses.</summary>
