...
{
    /// <summary>
    /// Adds Inventory System's UI to a project that uses UniMVC: once every dependency (UniMVC included) is
    ...
    /// the automatic copy runs once per project, and <c>Tools/Inventory System/Install MVC Scripts</c> adds any
    ...
    internal static class MvcIntegration
    {
        ...
        private const string SetupAssembly = "InventorySystem.Setup";
        private const string FallbackMvcRoot = "Assets/Scripts/MVC";
        private const string MenuPath = "Tools/Inventory System/Install MVC Scripts";
        private const string InstalledKey = "InventorySystem.Setup.MvcScriptsInstalled";
