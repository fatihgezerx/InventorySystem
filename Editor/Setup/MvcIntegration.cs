...
{
    /// <summary>
    /// Adds Inventory System's UI to a project that uses UniMVC, without being asked: copies the view scripts
    ...
    /// <list type="bullet">
    /// <item>Inventory System was just imported: the hidden <c>MVC/.pending</c> marker that ships with it is still
    ...
    /// <item>UniMVC was just imported (or imported again) into a project that already has Inventory System.</item>
    /// </list>
